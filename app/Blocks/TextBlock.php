...
class TextBlock extends Block
{
     ...
     * @var string
     */
    public $description = 'Block with two columns of text';
    ...
    public $template = [
        ...
        'core/paragraph' => ['placeholder' => 'Welcome to the Text Block block.'],
    ];
    ...
    {
        return 'wp-block-text-block bg-gray-200 py-10 lg:py-24';
    }
}
