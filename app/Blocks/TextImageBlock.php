...
class TextImageBlock extends Block
{
     ...
     * @var string
     */
    public $description = 'Block with text and image';
    ...
    public $template = [
        ...
        'core/paragraph' => ['placeholder' => 'Welcome to the Text Image Block block.'],
    ];
    ...
    {
        return 'wp-block-text-image-block py-6 lg:py-12';
    }
}
