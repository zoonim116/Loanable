  ...
  <div class="container">
    <div class="flex flex-col lg:flex-row justify-between">
      <div class="w-full lg:w-7/12">
        <a class="inline-block w-auto brand max-w-[120px] lg:max-w-[300px]" href="{{ home_url('/') }}">
          <img src="http://loanablemarketing.local/wp-content/uploads/2025/08/Vector-13.svg" alt="">
        </a>
        <div class="text-block text-sm mt-6 leading-relaxed">
          ...
          <p>Loanable is a trading style of My Secured Loan Ltd who is an appointed representative of Premier Mortgages North West Limited who are authorised and regulated by the Financial Conduct Authority 556587 registered in England and Wales No: 07679312. Registered Office: The Old Rectory, Rectory Lane, Winwick, Warrington, WA2 8LE.</p>
          <p>Calls may be recorded for training and monitoring purposes. Please see our <a href="#">Privacy Policy</a>.
            A summary of our internal complaints handling procedures for the reasonable and prompt handling of complaints is available on request and if you cannot settle your complaint with us, you may be entitled to refer it to the Financial Ombudsman Service at www.financial-ombudsman.org.uk or by contacting them on 0800 023 4567.</p>
        </div>
      </div>
      <div class="w-full lg:w-1/5 lg:w-1/6 text-block text-base">
        <p>
          Loanable,<br/>The Old Rectory,<br/>Rectory Lane,</br>Winwick,</br>Warrington,</br>WA2 8LE.
        </p>
        <p class="no-underline">
          <a href="tel:01925988055">01925 988055</a> <br/>
          <a href="mailto:hello@loanable.co.uk">hello@loanable.co.uk</a>
        </p>
        <div class="flex justify-between gap-2">
          <a href="#" class="w-8 h-8 bg-blue-600 transition hover:bg-pink-600 rounded-full p-2 flex justify-center items-center">
    ...
    <div class="border-t border-blue-50 pt-6 mt-6 text-sm">
      <p>Copyright © Loanable | Secured Loan Specialists 2025. All Rights Reserved.</p>
    </div>
  </div>
</footer>
