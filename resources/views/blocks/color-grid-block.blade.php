...
@endunless
    ...
    <div class="container">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
        <div class="bg-black-800 text-white p-8 lg:p-12 lg:pt-14 text-base lg:text-medium rounded-2xl">
        ...
        <div class="bg-pink-600 text-white p-8 lg:p-12 lg:pt-14 text-base lg:text-medium rounded-2xl">
          <div class="flex flex-col h-full">
            <div class="h-8 lg:h-10 mb-4 lg:mb-6">
